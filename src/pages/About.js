...
const Photo13      = require("../assets/photo04.jpeg");
...
export default function About() {
  ...
  return (
    <div>
          ...
          <div className="lg:-mx-6 lg:flex lg:items-center">
            ...
            <div class="lg:w-1/2 lg:mt-0 lg:mx-6 ">
                <p class="block mt-4 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">
                  Bem-vindos(as) ao meu blog oficial!
                </p>

                <p class="mt-6 text-sm text-gray-500 text-justify dark:text-gray-300 md:text-sm">
                  Sou um profissional que trabalha com tecnologia da informação desde 2016, tendo experiências em três empresas de software diferentes.
                </p>

                <p class="mt-3 text-sm text-gray-500 text-justify dark:text-gray-300 md:text-sm">
                  Tenho formação em tecnologia da informação e técnico de informática, ambos voltados a programação e pelo SENAI de Santa Catarina e atualmente estou estudando inglês no CCAA.
                </p>

                <p class="mt-3 text-sm text-gray-500 text-justify dark:text-gray-300 md:text-sm">
                  Meu foco para com este blog é dividar um pouco da minha vida pessoal e profissional. No âmbito profissional busco compartilhar experiências e práticas utilizadas em meu dia a dia como programador.
                </p>
        ...
        <div className="p-5 lg:px-20 container py-5 mx-auto">
          <p class="mt-3 text-sm text-gray-500 text-justify dark:text-gray-300 md:text-sm">
            Sou natural do estado de Santa Catarina, cidade de Jaraguá do Sul no Brasil e atualmente residindo por lá, cidade de pouco mais de 180 mil habitantes.
          </p>

          <p class="mt-3 text-sm text-gray-500 text-justify dark:text-gray-300 md:text-sm">
          Comecei minha carreira em 2016, atuando como estagiário de desenvolvimento de sistemas, de início trabalhando e estudando a linguagem Delphi, na época sem muito conhecimento de programação, assistia bastante vídeos de conteúdos relacionados e melhores práticas. Quanto a negócios, obtive conhecimento sobre sistemas SaaS voltados para indústrias, comércios e contábeis.
          </p>
        </div>
      {/* </article> Sejam todos bem vindos ao meu blog pessoal, meu nome é Julio, sou formado e trabalho com tecnologia há aproximadamente 6 anos.
                Meu foco para com este blog é compartilhar experiências, conhecimentos e um pouco da minha vida pessoal e profissional. */}

      <hr class="w-48 h-1 mx-auto my-4 bg-blue-500 border-0 rounded md:my-10 dark:bg-gray-700"></hr>

       <section class="p-5 lg:px-20 lg:mt-5 container py-5 mx-auto">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    <h4 class="text-dark mb-1 text-xl font-bold">Localização</h4>
                ...
                <div class="mb-4 flex w-full max-w-[370px]">
                  ...
                  {/* <div class="w-full">
                    <h4 class="text-dark mb-1 text-xl font-bold">Telefone / WhatsApp</h4>
                    <p class="text-body-color text-base">+55 (47) 9 9639-5743</p>
                  </div> */}
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div
                  ...
                  <div class="w-full">
                    <h4 class="text-dark mb-1 text-xl font-bold">Endereço de Email</h4>
                    <p class="text-body-color text-base">juliothomazelli@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
