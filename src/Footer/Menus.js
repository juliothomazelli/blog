...
export const Icons = [
  ...
  { 
    name: "logo-gmail", 
    link: "#",
    svg:  <div onClick={() => {openGmail()}}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24x" height="24px">
...
function openLinkedin(){
  window.open("https://www.linkedin.com/in/julio-thomazelli-7548a9152/");
}

function openGmail(){
  window.open("mailto:juliothomazelli@gmail.com");
}

function openGithub(){
  window.open("https://github.com/juliothomazelli");
}